  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center space-y-12 font-montserrat">
      ...
      <div className="flex flex-col items-center justify-center space-y-5">
        <h1 className="font-montserrat text-base font-bold">Our services</h1>
        <hr className="h-0.5 w-[44px] bg-black" />
        <p className="flex flex-col items-center font-montserrat text-sm font-light text-[#7D7987]">
          We provide to you the best choiches for you. Adjust it to your health
          needs and make sure your undergo treatment with
          <p className="font-montserrat text-sm font-light text-[#7D7987]">
